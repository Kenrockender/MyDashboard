...
export default function ProjectsView() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* The form gets the full width to itself, like the Clients page. Once a
          project is selected the list shrinks into a sidebar, which is far too
          narrow for a multi-column form — so it steps aside until you go back. */}
      {!selectedId && <NewProjectForm />}

      <div
        className={
          selectedId ? 'lg:grid lg:grid-cols-[380px_1fr] lg:items-start lg:gap-6' : undefined
        }
      >
