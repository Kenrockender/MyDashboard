...
describe('GET /api/reports/expenses/pdf', () => {
  beforeEach(() => {
    jest.resetAllMocks();
  });

  it('returns a PDF response wired to the expense breakdown data', async () => {
    ...
    const req = new NextRequest('http://localhost/api/reports/expenses/pdf');
